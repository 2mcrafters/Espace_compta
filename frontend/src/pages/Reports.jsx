      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-3 py-1 rounded ${
            tab === "productivity" ? "bg-primary-600 text-white" : "bg-gray-100"
          }`}
        >
          Productivité
        </button>
        <button
          ...
          className={`px-3 py-1 rounded ${
            tab === "timesheet" ? "bg-primary-600 text-white" : "bg-gray-100"
          }`}
        >
          Feuille de temps
        </button>
        ...
        >
          <button
            ...
            className={`px-3 py-1 rounded ${
              tab === "costs" ? "bg-primary-600 text-white" : "bg-gray-100"
            }`}
          >
            Coûts clients
          </button>
      ...
      {tab === "productivity" && (
        <div className="grid md:grid-cols-2 gap-6">
          <div className="border rounded-xl overflow-hidden">
            <div className="px-3 py-2 font-semibold bg-gray-50 border-b">
              Minutes par client
            </div>
